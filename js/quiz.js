...
function wrongResponse() {
	...
	$("#sample-vid").addClass("fader");
	$(".answer").prop("disabled", true);
	document.getElementById("outcome").innerHTML = '<h3>Incorrect</h3><br>Perhaps you should start with your <a href="expression.html#ABC">ABC\'s</a> <br><br><br>Or prefer to try more <a href="quiz.html">quizzes?</a>';
}
